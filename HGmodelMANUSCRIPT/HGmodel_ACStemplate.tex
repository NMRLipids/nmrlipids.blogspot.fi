...
forking (see Sec.~\ref{expORDp}) of the order parameters in g$_1$ and g$_3$ segments, in contrast to the choline segments $\alpha$ and $\beta$. 
...
and the stereospecific labeling from~\cite{gally81}, and is shown in Fig.~\ref{HGorderparameters2}.
\begin{figure*}[]
  \centering
