...
Notably, the structures sampled in a simulation that reproduces these %and other experimental
...
These contributions are summarized in the Supplementary Information. %(the location depends on the journal probably).
...
repository (\url{https://github.com/NMRlipids}). \todo{I will not assign a doi yet. We can wait for the journal decision.}.
...
The measured sign is negative for almost all the carbons discussed in this work, only the choline $\alpha$ is positive~\cite{hong95a,hong95b,gross97}. 
...
In comparison, the choline responses of CHARMM36 and MacRog are in better qualitative agreement with experiments, and the glycerol backbone responses, 
although still somewhat larger than what is seen experimentally,
much less drastic.
Therefore,
to resolve the nature of cholesterol-induced structural changes,
we calculated from CHARMM36 the glycerol backbone dihedral angle distributions
at various cholesterol contents (Supplementary material): The only detectable change
