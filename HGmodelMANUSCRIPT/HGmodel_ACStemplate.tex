...
for all fully hydrated PC bilayers, regardless of the variation in their acyl chain composition and temperature.
...
Fig.~\ref{HGorderparameters} the subjective sweet spots (light blue areas spanning 0.04 units), within which we expect the calculated absolute 
