...
and both ($\beta$ and $\alpha$) show increase with decreasing hydration level. It should be noted that only 
...
Slight decrease for the glycerol backbone order parameters have been observed with dehydration~\cite{dvinskikh05b}.
\begin{figure}[]
  \centering
...
However, the used simulation models are typically not compared to the experimental choline and glycerol backbone
...
The increase of the choline order parameters with dehydration is seen in all
...
all models as a function of dehydration (Fig.~\ref{PNangle}). However,
...
experiments than the other three models. Thus the relatively modest tilting with dehydration
