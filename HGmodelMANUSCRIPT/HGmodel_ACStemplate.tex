...
according to the guidelines defined in the beginning of the project~\cite{creditsPOST}\todo{DONE}. 
...
For a more detailed discussion see Ref.~\citenum{accuracyPOST}. \todo{DONE}
...
For more detailed discussion about the sign measurements of the order parameters see Ref.~\citenum{signpost}. \todo{DONE}
...
\begin{tabular}{l l r r r r r c c c}
%\hline
Force field & lipid & $^a$N$_{\rm l}$   &  $^b$N$_{\rm w}$ &  $^c$T (K)  &  $^d$t$_{{\rm sim}}$(ns) &  $^e$t$_{{\rm anal}}$ (ns) &  $^f$Files  &  $^g$Details & Notes\\
\hline
...
CHARMM36~\cite{klauda10}  & DPPC &  72 & 2189 & 323 &  ? &  130? & [?]$^*$    & ? & Magnitudes from Fig.~S4 of Klauda et al.~\cite{klauda10}, signs matched to our simulations. \\
...
{\bf
MacRog}~\cite{maciejewski14} & POPC & 128 &  6400 & 310 & 400 & 200 & [\citenum{macrogCHOLfiles}]$^*$  & SI  \\
MacRog~\cite{maciejewski14}  & POPC & 288 & 14400 & 310 &  90 &  40 & [\citenum{macrogdehydFILES}]$^*$ & SI  \\
GAFFlipid~\cite{dickson12}   & DPPC &  72 & 2197 & 323 &  90 & 50 & [\citenum{GAFFlipidFILESdppc}]$^*$ & SI \\
GAFFlipid~\cite{dickson12}   & DPPC &  ? & ? & 323 & ? &  250? & [?]$^*$    & ? & Magnitudes from Fig.~9 of Dickson et al.~\cite{dickson12}, signs matched to our simulations. \\
{\bf
...
For more details, see Ref.~\citenum{accuracyPOST}. \todo{DONE}
...
\begin{figure*}[]
  ...
  \todo{This figure should be updated similar to Fig.~\ref{HGorderparameters}. DONE.} \\
...
(see Ref.~\citenum{accuracyPOST} for more discussion.) \todo{DONE}
...
available~\cite{nmrlipids}. \todo{DONE} 
