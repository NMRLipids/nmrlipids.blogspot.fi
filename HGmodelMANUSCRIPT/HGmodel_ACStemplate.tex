...
The interpretation reveals that the increased choline order parameters indicate P--N vector tilting more parallel to membrane,
...
\begin{figure}[]
  ...
  \todo{It should be checked that we have the up-to-date GAFF results in this plot.} \\
...
\todo{This sentence must be rewritten after the up-to-date results for GAFFlipid are in the figure.}
...
\begin{figure}[]
  ...
  \todo{The data delivered by Fernando Favela should be added here.} \\
...
HS acknowleges Catherine Etchebest and St\'ephane T\'eletch\'ea for useful discussions and continued support, GENCI-CINES for the HPC resources (Grant 2014-c2014077209).
