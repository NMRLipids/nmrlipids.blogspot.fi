...
\todo{Markus has now made a new figure with signs included. I think that this is very good. I also think that we should try to get the interactive figure behind permalink (i.e. Zenodo or figshare) and cite that in the paper.}
...
\todo{This kind of table should be done or not? DONE, see Fig.~\ref{FullHydrationComparisonTable}}.
\begin{figure}[]
  \centering
...
\todo{Several people think that this plot should be clarified. ------> DONE.}
