...
plot "BERGERnaclCONS.dat" using 1:2 title 'POPC, Berger, T=298K' with linespoint linetype 1 pt 5, \
     ...
     "./betaORDPnaCONSexpSIGN.dat"  using 1:2 title 'DPPC, ^2H NMR, T=332K' with linespoints  linetype 2 pt 7 lc rgb 'black'
...
plot "BERGERnaclCONS.dat" using 1:4 notitle  with linespoint linetype 1 pt 5, \
     ...
     "./alphaORDPnaCONSexp.dat"  using 1:2 notitle with linespoints  linetype 2 pt 7 lc rgb 'black'
